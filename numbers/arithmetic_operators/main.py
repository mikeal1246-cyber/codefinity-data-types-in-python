...
# Print results
print("Total minutes needed:", total_minutes, "minutes")
print("Minutes short:", shortfall, "minutes")
print("Completed calls:", completed_calls, "calls")
print("Unused time:", unused_time, "minutes")